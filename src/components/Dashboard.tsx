...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  const { currentUser, examAttempts, mistakes, analytics, getQuestionById } = useApp();
    ...
    <div className="space-y-4 sm:space-y-6 pb-6">
      ...
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          ...
          <p className="text-[#8A8A70] text-xs sm:text-sm mt-0.5">
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4">
        ...
        <div className="bg-white p-3.5 sm:p-5 rounded-2xl sm:rounded-[2rem] shadow-xs border border-[#EAE7E0] flex flex-col justify-between">
          <div>
            <p className="text-[10px] sm:text-xs uppercase font-bold text-[#8A8A70] mb-0.5">Câu đã làm</p>
        ...
        <div className="bg-white p-3.5 sm:p-5 rounded-2xl sm:rounded-[2rem] shadow-xs border border-[#EAE7E0] flex flex-col justify-between">
          <div>
            <p className="text-[10px] sm:text-xs uppercase font-bold text-[#8A8A70] mb-0.5">Ngày liên tiếp</p>
            <h3 className="text-2xl sm:text-3xl font-bold text-[#5A5A40]">{currentUser.streakDays}</h3>
          </div>
          <p className="text-[10px] sm:text-[11px] text-[#8BA888] font-semibold mt-1.5">Duy trì phong độ tốt!</p>
        </div>
        ...
        >
          <div>
            <p className="text-[10px] sm:text-xs uppercase font-bold text-white/70 mb-0.5">Lượt thi thử</p>
            <h3 className="text-2xl sm:text-3xl font-bold">{examAttempts.length.toString().padStart(2, '0')}</h3>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
        ...
        >
          ...
          <h4 className="font-bold text-xs sm:text-sm text-[#3D3D2D] leading-tight">Thi thử Đề chuẩn</h4>
          <p className="text-[10px] sm:text-[11px] text-[#8A8A70] mt-0.5">50 câu / 60 phút</p>
        </button>
        ...
        >
          ...
          <h4 className="font-bold text-xs sm:text-sm text-[#3D3D2D] leading-tight">Luyện Nhanh 10 câu</h4>
          <p className="text-[10px] sm:text-[11px] text-[#8A8A70] mt-0.5">Phản xạ ngẫu nhiên</p>
        </button>
        ...
        >
          ...
          <h4 className="font-bold text-xs sm:text-sm text-[#3D3D2D] leading-tight">Flashcard Từ vựng</h4>
          <p className="text-[10px] sm:text-[11px] text-[#8A8A70] mt-0.5">Unit 1-12 Lớp 9</p>
        </button>
        ...
        >
          ...
          <h4 className="font-bold text-xs sm:text-sm text-[#3D3D2D] leading-tight">Lý thuyết & Mẹo</h4>
          <p className="text-[10px] sm:text-[11px] text-[#8A8A70] mt-0.5">Công thức trọng tâm</p>
        </button>
      </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl sm:rounded-[2.5rem] p-4 sm:p-6 lg:p-8 shadow-xs border border-[#EAE7E0] flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <h4 className="text-base sm:text-lg font-bold text-[#3D3D2D]">Tiến độ theo chủ đề</h4>
              <button
          ...
          <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-[#F5F2ED]">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
              <div>
                <p className="text-xs sm:text-sm font-bold text-[#3D3D2D]">Gợi ý từ hệ thống</p>
